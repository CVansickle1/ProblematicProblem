...
namespace ProblematicProblem
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            bool cont = Method.Participate(Console.ReadLine());
            Console.WriteLine();
            ...
            bool seeList = Method.Participate(Console.ReadLine());
            if (seeList)
            {
                ...
                bool addToList = Method.Participate(Console.ReadLine());
                Console.WriteLine();
                ...
                while (addToList)
                {
                    ...
                    addToList = Method.Participate(Console.ReadLine());
                }
            }
            ...
            while (cont)
            {
                ...
                cont = Method.Participate(Console.ReadLine());
            }
        }
    }
}